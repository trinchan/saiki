...
func (f *dynamicFactory) ClientForGroupVersionResource(gv schema.GroupVersion, resource metav1.APIResource, namespace string) (Dynamic, error) {
	...
	return &dynamicResourceClient{
		...
		gvk:            gvk,
		namespace:      namespace,
		resourceClient: f.dynamicClient.Resource(gvr).Namespace(namespace),
	}, nil
}
...
func (d *dynamicResourceClient) GroupVersionResource() schema.GroupVersionResource {
	return d.gvr
}

func (d *dynamicResourceClient) GroupVersionKind() schema.GroupVersionKind {
	return d.gvk
}

func (d *dynamicResourceClient) Namespace() string {
	return d.namespace
}
